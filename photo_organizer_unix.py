...
Date = 12/22/2020
Description:
    takes in a given folder which contains a list of photos (no sub-folders), and the folder in which to create an
...
# a backup check to make sure that the script has bound to the correct directory
...
# scans the source directory to verify that the script will be
